...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-10 items-center justify-center rounded-md bg-muted p-1 text-muted-foreground w-full max-w-md mx-auto",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <div className="relative group flex-1">
    ...
    <div className={cn(
      "absolute inset-0 rounded-sm opacity-0 transition-all duration-300",
    ...
    <TabsPrimitive.Trigger
      ...
      className={cn(
        ...
        "hover:scale-105 hover:shadow-md active:scale-95 hover:z-20",
        "data-[state=active]:scale-110 data-[state=active]:shadow-lg data-[state=active]:z-20 data-[state=active]:transform data-[state=active]:translate-y-[-2px]",
        className
      )}
      {...props}
    />
